...
public final class DeleteTaskPushNotificationConfigRequest extends NonStreamingJSONRPCRequest<DeleteTaskPushNotificationConfigParams> {
    ...
    public DeleteTaskPushNotificationConfigRequest(@JsonProperty("jsonrpc") String jsonrpc, @JsonProperty("id") Object id,
        ...
        if (! method.equals(DELETE_TASK_PUSH_NOTIFICATION_CONFIG_METHOD)) {
            throw new IllegalArgumentException("Invalid DeleteTaskPushNotificationRequest method");
        }
    ...
    public DeleteTaskPushNotificationConfigRequest(String id, DeleteTaskPushNotificationConfigParams params) {
        this(null, id, DELETE_TASK_PUSH_NOTIFICATION_CONFIG_METHOD, params);
    }
    ...
    public static class Builder {
        ...
        public DeleteTaskPushNotificationConfigRequest.Builder jsonrpc(String jsonrpc) {
            this.jsonrpc = jsonrpc;
            return this;
        }

        public DeleteTaskPushNotificationConfigRequest.Builder id(Object id) {
            this.id = id;
            return this;
        }

        public DeleteTaskPushNotificationConfigRequest.Builder method(String method) {
            this.method = method;
            return this;
        }

        public DeleteTaskPushNotificationConfigRequest.Builder params(DeleteTaskPushNotificationConfigParams params) {
            this.params = params;
            return this;
        }
